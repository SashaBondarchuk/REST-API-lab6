...
const isValidDateTime = (dateTime)=>(0, _momentDefault.default)(dateTime, "YYYY-MM-DD", true).isValid();
const onShowButtonClick = (event)=>{
    ...
    fetch(`https://russianwarship.rip/api/v2/statistics/${refs.inputEl.value}`).then((response)=>response.json()).then((json)=>{
